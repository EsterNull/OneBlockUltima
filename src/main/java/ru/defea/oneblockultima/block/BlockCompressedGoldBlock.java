...
public class BlockCompressedGoldBlock extends BlockCompressedBase {
    ...
    {
        super(LEVEL, Properties.of().mapColor(MapColor.GOLD).strength(3F * 9F, 10F * 9F).sound(SoundType.METAL), "compressed_gold_block");
    }
    ...
    public float getExplosionResistance(@Nonnull BlockState state, @Nonnull BlockGetter world, @Nonnull BlockPos pos, @Nonnull Explosion explosion) {
        return Blocks.GOLD_BLOCK.getExplosionResistance() * 9.0F;
    }
}
